export default function About() {
  return (
    <section
      id="about"
      className="bg-gray-900 relative text-white flex flex-col md:flex-row items-center justify-center px-6 md:py-16 py-10 md:px-20 gap-16 font-sans"
      style={{ fontFamily: "'Inter', sans-serif" }}
    >
      {/* Left side - Logo / Visual */}
      <div className="hidden relative md:flex items-center justify-center w-full md:w-1/3 animate-fadeInLeft">
        <div className="bg-gradient-to-tr animate-pulse from-cyan-600/50 to-blue-500/50 backdrop-blur-md rounded-full w-56 h-56 flex items-center justify-center shadow-lg shadow-cyan-600/40">
